...
BattleOfDistantHoriz-Linux-Debug:
	 $(PROJECTBUILD) BattleOfDistantHoriz Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHoriz-Linux-DebugGame:
	 $(PROJECTBUILD) BattleOfDistantHoriz Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHoriz-Linux-Shipping:
	 $(PROJECTBUILD) BattleOfDistantHoriz Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHoriz-Linux-Test:
	 $(PROJECTBUILD) BattleOfDistantHoriz Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHoriz:
	 $(PROJECTBUILD) BattleOfDistantHoriz Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHorizEditor-Linux-Debug:
	 $(PROJECTBUILD) BattleOfDistantHorizEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHorizEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BattleOfDistantHorizEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHorizEditor-Linux-Shipping:
	 $(PROJECTBUILD) BattleOfDistantHorizEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHorizEditor-Linux-Test:
	 $(PROJECTBUILD) BattleOfDistantHorizEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleOfDistantHorizEditor:
	 $(PROJECTBUILD) BattleOfDistantHorizEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
