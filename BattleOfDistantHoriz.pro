...
include(BattleOfDistantHorizSource.pri)
include(BattleOfDistantHorizHeader.pri)
include(BattleOfDistantHorizConfig.pri)
include(BattleOfDistantHorizIncludes.pri)
include(BattleOfDistantHorizDefines.pri)

BattleOfDistantHoriz-Linux-Debug.commands = $$build BattleOfDistantHoriz Linux Debug  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHoriz-Linux-DebugGame.commands = $$build BattleOfDistantHoriz Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHoriz-Linux-Shipping.commands = $$build BattleOfDistantHoriz Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHoriz-Linux-Test.commands = $$build BattleOfDistantHoriz Linux Test  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHoriz.commands = $$build BattleOfDistantHoriz Linux Development  -project="\"$$gameProjectFile\"" $$args

BattleOfDistantHorizEditor-Linux-Debug.commands = $$build BattleOfDistantHorizEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHorizEditor-Linux-DebugGame.commands = $$build BattleOfDistantHorizEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHorizEditor-Linux-Shipping.commands = $$build BattleOfDistantHorizEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHorizEditor-Linux-Test.commands = $$build BattleOfDistantHorizEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BattleOfDistantHorizEditor.commands = $$build BattleOfDistantHorizEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	BattleOfDistantHoriz-Linux-DebugGame \
	BattleOfDistantHoriz-Linux-Shipping \
	BattleOfDistantHoriz-Linux-Test \
	BattleOfDistantHoriz \
	BattleOfDistantHorizEditor-Linux-Debug \
	BattleOfDistantHorizEditor-Linux-DebugGame \
	BattleOfDistantHorizEditor-Linux-Shipping \
	BattleOfDistantHorizEditor-Linux-Test \
	BattleOfDistantHorizEditor \
